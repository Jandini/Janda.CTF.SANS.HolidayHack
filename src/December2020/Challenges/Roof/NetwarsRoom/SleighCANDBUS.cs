...
{  
    ...
    public class SleighCANDBUS : IChallenge
    {
        ...
        public SleighCANDBUS(ILogger<SleighCANDBUS> logger)
        {
            _logger = logger;
        }
        ...
        public void Run()
        {
            ...
            ".LogNote(_logger, "First exlude all to see what is wrong");
            ...
            ".LogNote(_logger, "Exclude following messages to defrost Sleigh!");
        }
    }
}
