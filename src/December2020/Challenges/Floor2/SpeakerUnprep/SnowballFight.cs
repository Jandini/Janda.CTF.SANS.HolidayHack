...
namespace Janda.CTF.SANS.HolidayHack
{
    public class SnowballFight : IChallenge
    {
        ...
        public void Run()
        {
            ...
            string.Join(",", numbers).LogMessage(_logger);
            ...
            ".LogMessage(_logger, "Player (seed) = 0... if i could only relate the random value to the position... less likely...");
            ...
            <!--
                ...
                <Redacted!> - Perfect!
              -->
            ".LogMessage(_logger, "Found in page source when run with impossible difficulty level.");
            ...
            ("seeds = [" + string.Join(",", seeds) + "]").LogMessage(_logger, "{0} random numbers. Use them to clone MT seed table and get the next `Player Name` number. ", seeds.Count);
