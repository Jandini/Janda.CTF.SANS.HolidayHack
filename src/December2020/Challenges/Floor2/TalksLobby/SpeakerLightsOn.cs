...
namespace Janda.CTF.SANS.HolidayHack
{
    public class SpeakerLightsOn : IChallenge
    {
        ...
        public void Run()
        {
            ...
            ".Blog(_logger, "---t is {a}?, hin--- is {b}", "---t", "hin---");


            @"
                password: E$ed633d885dcb9b2f3f0118361de4d57752712c27c5316a95d9e5e5b124
                name: elf-technician
            ".Blog(_logger, "cat /home/elf/lights.conf");
            ...
            ".Blog(_logger, "Removed one character from the password.");


            @"Couldn't read config file: Badly formatted line (expected: ""key: value""): ".Blog(_logger, "Remove entire password");
            ...
            ".Blog(_logger, "Rename {name} to {encrypted} in ./lab/lights.conf to get {answer}", "elf-technician", "E$ed633d885dcb9b2f3f0118361de4d57752712c27c5316a95d9e5e5b124", "Computer-TurnLightsOn");
